...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    shortDescription:
      "Organize your credit card portfolio to optimize points and cashback.",
    fullDescription:
      "A robust credit card management application designed to help users optimize their financial rewards. Perk allows users to track their credit card portfolio, compare benefits side-by-side, and manage card details including fees, bonuses, and opening dates. Built with a scalable Java Spring Boot backend and a modern React frontend using shadcn/ui.",
    techStack: [
      "React",
      "Tailwind CSS",
      "JavaScript",
    ...
    repoLinks: [
      {
        label: "Frontend",
        url: "https://github.com/paulhwang1007/credit-card-tracker-frontend",
      },
      {
        label: "Backend",
        url: "https://github.com/paulhwang1007/credit-card-tracker",
      },
    ],
    span: "md:col-span-2 md:row-span-2",
    features: [
    ...
    gallery: [
      "/images/perk-dashboard.png",
      "/images/perk-compare.png",
      "/images/perk-add-card.png",
    ],
  },
  {
    id: "cornell-roster",
    ...
    fullDescription:
      "A minimal, responsive frontend web app that allows users to explore Cornell University courses by semester, using the official Cornell Roster API. It provides a seamless experience for students to find and track their courses.",
    techStack: [
      "React",
      "Tailwind CSS",
      "HTML/CSS",
    ...
    liveLink: "https://cornell-roster.vercel.app/",
  ...
  },
  {
    ...
    category: "Web App",
    shortDescription:
      "Official Website for Cornell University Sustainable Design (2025-2026).",
    fullDescription:
      "The official website for the project team Cornell University Sustainable Design constructed for 2025-2026 following a provided Figma design and restricted to vanilla HTML, CSS, and Javascript.",
